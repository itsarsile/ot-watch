...
import { Group, Menu, Radio, Select, Stack, TextInput, rem } from "@mantine/core";
    ...
    cell: ({ row }) => {
        ...
        validate: {
          ...
          visitorTrackId: (value, values) => {
            if (values.visitorDealing === "dealing") {
              return value && value.length < 1 ? "Track ID pengunjung wajib diisi" : null
            }
            return null
          }
        },
      ...
      return (
        <Menu width={rem(150)}>
          ...
          <Menu.Dropdown>
            <Menu.Item component="button" onClick={handleOpenModal}>
              Edit
            </Menu.Item>
